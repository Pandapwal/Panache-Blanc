    ...
    handleSubmit(event){
        ...
        axios.post('http://localhost:4000/auth/login', {email, password})
            .then((res) => {
                ...
                document.cookie = 'my-token='+res.data.token;
                console.log("successfully logged in");
                this.setState({isLoggedIn: res.data.auth});
                this.props.setAuth(res.data.auth);
            })
            .catch((error) => {
                console.log(error);
            });
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-10 col-xl-7 p-3 mx-auto login-round darker-shade">
                                        <h3 className="display-4 text-center mb-5">Connexion</h3>
